...
class Player(pyglet.sprite.Sprite):
    ...
    def __init__(self, network=None):
        if self.img is None:
            ...
            self.img.anchor_x = 3
            self.img.anchor_y = 5
        pyglet.sprite.Sprite.__init__(self, self.img, x=10, y=120)
        self.rotation = -52
        self.rot = math.radians(self.rotation)
        self.sin_rotation = math.sin(math.radians(self.rotation))
        self.cos_rotation = math.cos(math.radians(self.rotation))
        self.steering = 0.
